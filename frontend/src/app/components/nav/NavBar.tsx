...
export default function NavBar() {
  ...
  return (
    <nav
      className={`fixed w-full top-0 py-2.5 px-12 flex justify-between items-center z-50 transition-colors duration-300 ${scrolled ? 'bg-[var(--background)] backdrop-blur-sm border-b border-[var(--border)]' : 'bg-transparent'}`}
    >
      <div>
